              ...
              <div className="bg-primary-blue rounded-[40px] overflow-hidden flex flex-col group hover:shadow-2xl transition-all duration-500 cursor-pointer border border-white/20 h-full">
                <div className="h-64 relative overflow-hidden">
                  <img 
                    src={lab.image} 
                    alt={lab.title} 
                    className={`w-full h-full object-cover transition-transform duration-700 ${((lab as any).position) ? 'scale-125' : 'scale-100'} group-hover:scale-150`} 
                    style={{ objectPosition: (lab as any).position || 'center' }}
                  />
